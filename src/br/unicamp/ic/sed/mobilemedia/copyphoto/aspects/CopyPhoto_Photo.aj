...
public abstract aspect CopyPhoto_Photo {
	...
	declare soft : NullAlbumDataReference : handleException();
		
	declare soft : ImageNotFoundException :handleException();
	
	declare soft : InvalidImageDataException :handleException();

	declare soft : PersistenceMechanismException :handleException();
