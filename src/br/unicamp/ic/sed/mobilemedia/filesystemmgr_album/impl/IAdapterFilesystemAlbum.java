...
public class IAdapterFilesystemAlbum implements IFilesystem {
	...
	public void addNewPhotoToAlbum(String imageName, String imagePath,
			String albumName) throws br.unicamp.ic.sed.mobilemedia.album.spec.excep.InvalidImageDataException, br.unicamp.ic.sed.mobilemedia.album.spec.excep.PersistenceMechanismException {
		...
		filesystem.addNewPhotoToAlbum(imageName, imagePath, albumName);
			...
			throw new br.unicamp.ic.sed.mobilemedia.album.spec.excep.InvalidImageDataException(e.getMessage());
	...
	public void deleteImage(String imageName, String albumName) throws br.unicamp.ic.sed.mobilemedia.album.spec.excep.PersistenceMechanismException, br.unicamp.ic.sed.mobilemedia.album.spec.excep.ImageNotFoundException {
		IManager manager = ComponentFactory.createInstance();
		br.unicamp.ic.sed.mobilemedia.filesystemmgr.spec.prov.IFilesystem filesystem = (br.unicamp.ic.sed.mobilemedia.filesystemmgr.spec.prov.IFilesystem)manager.getRequiredInterface("IFilesystem");
		...
		try {
			...
			throw new br.unicamp.ic.sed.mobilemedia.album.spec.excep.ImageNotFoundException(e.getMessage());
		}
	...
	public Image getImageFromRecordStore(String albumName, String imageName) throws br.unicamp.ic.sed.mobilemedia.album.spec.excep.ImageNotFoundException, br.unicamp.ic.sed.mobilemedia.album.spec.excep.PersistenceMechanismException
	 {
		IManager manager = ComponentFactory.createInstance();
		br.unicamp.ic.sed.mobilemedia.filesystemmgr.spec.prov.IFilesystem filesystem = (br.unicamp.ic.sed.mobilemedia.filesystemmgr.spec.prov.IFilesystem)manager.getRequiredInterface("IFilesystem");
		try {
	...
	public IImageData getImageInfo(String imageName) throws br.unicamp.ic.sed.mobilemedia.album.spec.excep.ImageNotFoundException, br.unicamp.ic.sed.mobilemedia.album.spec.excep.NullAlbumDataReference {
		IManager manager = ComponentFactory.createInstance();
		br.unicamp.ic.sed.mobilemedia.filesystemmgr.spec.prov.IFilesystem filesystem = (br.unicamp.ic.sed.mobilemedia.filesystemmgr.spec.prov.IFilesystem)manager.getRequiredInterface("IFilesystem");
		try {
			...
			throw new br.unicamp.ic.sed.mobilemedia.album.spec.excep.NullAlbumDataReference(e.getMessage());
		}
	}

	public IImageData[] getImages(String albumName) throws br.unicamp.ic.sed.mobilemedia.album.spec.excep.UnavailablePhotoAlbumException{
		IManager manager = ComponentFactory.createInstance();
		br.unicamp.ic.sed.mobilemedia.filesystemmgr.spec.prov.IFilesystem filesystem = (br.unicamp.ic.sed.mobilemedia.filesystemmgr.spec.prov.IFilesystem)manager.getRequiredInterface("IFilesystem");
		...
		try {
			...
			throw new br.unicamp.ic.sed.mobilemedia.album.spec.excep.UnavailablePhotoAlbumException(e.getMessage());
		}
	...
	public void updateImageInfo(IImageData velhoID, IImageData novoID) throws br.unicamp.ic.sed.mobilemedia.album.spec.excep.InvalidImageDataException, br.unicamp.ic.sed.mobilemedia.album.spec.excep.PersistenceMechanismException {
		IManager manager = ComponentFactory.createInstance();
		br.unicamp.ic.sed.mobilemedia.filesystemmgr.spec.prov.IFilesystem filesystem = (br.unicamp.ic.sed.mobilemedia.filesystemmgr.spec.prov.IFilesystem)manager.getRequiredInterface("IFilesystem");
		try {
