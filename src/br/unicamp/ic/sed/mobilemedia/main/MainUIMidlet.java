...
public class MainUIMidlet extends MIDlet implements IMobileResources {
	...
	br.unicamp.ic.sed.mobilemedia.captureMedia.spec.prov.IManager captureMedia;
	br.unicamp.ic.sed.mobilemedia.mainuimidlet_connector_VP.impl.IManager mainuimidlet_connector_variant;
	
	br.unicamp.ic.sed.mobilemedia.excep_album.impl.IManager eh_album;
	br.unicamp.ic.sed.mobilemedia.excep_connector_VP.impl.IManager eh_connector_variant;
	...
	public void startApp() throws MIDletStateChangeException {
		...
		captureMedia = br.unicamp.ic.sed.mobilemedia.captureMedia.impl.ComponentFactory.createInstance();
		...
		eh_album = br.unicamp.ic.sed.mobilemedia.excep_album.impl.ComponentFactory.createInstance();
		eh_connector_variant = br.unicamp.ic.sed.mobilemedia.excep_connector_VP.impl.ComponentFactory.createInstance();
		...
		video.setRequiredInterface( "IMobileResources" , mainuimidlet_connector_variant.getProvidedInterface("IMobileResourcesVideo") );
		video.setRequiredInterface( "IFilesystemVideo" ,  filesystem_connector_variant.getProvidedInterface( "IFilesystemVideo"  ));
		
		mainuimidlet_connector_variant.setRequiredInterface("IMobileResources", this );
		captureMedia.setRequiredInterface("IMobileResources", mainuimidlet_connector_variant.getProvidedInterface("IMobileResourcesCaptureMedia") );
		captureMedia.setRequiredInterface( "IFilesystem" ,  filesystem_connector_variant.getProvidedInterface( "IFilesystemCaptureMedia" ));
