...
public class Variant {
	...
	public Variant(){
		providedInterfaces.put("IMobileResourcesCaptureMedia",new AdapterResourcesCaptureMedia() ) ;
		providedInterfaces.put("IMobileResourcesMusic",new AdapterResourcesMusic() ) ;
		providedInterfaces.put("IMobileResourcesVideo",new AdapterResourcesVideo() ) ;
